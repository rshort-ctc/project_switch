...
`127.0.0.1:55601` by default. It never connects directly to the database, vector
...
`0.0.0.0:55602` by default and limited to chat and repository views. Diagnostics,
